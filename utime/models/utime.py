...
class UTime(Model):
    ...
    def __init__(self,
                 ...
                 TransferLearning2=False,
                 GradualTraining=False,
                 InverseGradualTraining=False,
                 dropout=False,
                 **kwargs):
        """
        n_classes (int):
        ...
        self.TransferLearning2 = TransferLearning2
        self.GradualTraining = GradualTraining
        self.InverseGradualTraining = InverseGradualTraining
        self.n_crops = 0
    ...
    def init_model(self, inputs=None, create_seg_modeling=True, name_prefix="", name_prefix_2=""):
        """
        ...
        # By adding 'TL_' as a prefix, weights will be initialized according to the loaded model
        # for the encoder-decoder (the invariant part) and randomly for the final layers 
        # (which are supposed to belong to different classes)
        if self.TransferLearning:
            name_prefix_2 = "TL_"
        # TL of TL: e.g Sleep --> TCV --> JET
        elif self.TransferLearning2:
            name_prefix_2 = "TL_TL_"
        ...
        settings = {
            ...
            "trainable": True,
            "GradualTraining": self.GradualTraining,
            "InverseGradualTraining": self.InverseGradualTraining,
    ...
    def log(self):
        ...
        self.logger("TransferLearning:         {}".format(self.TransferLearning))
        self.logger("TransferLearning2:         {}".format(self.TransferLearning2))
